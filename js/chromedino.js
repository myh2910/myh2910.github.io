// From https://chromedino.com/js/game.js
	...
	Runner.prototype = {
		...
		playIntro: function() {
			if (!this.started && !this.crashed) {
				...
				document.styleSheets[1].insertRule('@-webkit-keyframes intro { ' + 'from { width:' + Trex.config.WIDTH + 'px }' + 'to { width: ' + this.dimensions.WIDTH + 'px }' + '}', 0);
